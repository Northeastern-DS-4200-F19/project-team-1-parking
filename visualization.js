...
agg_data = d3.csv('./Aggregated_FINALV2.csv').then(function(d){return d});
...
function drawIntersections(intersections) {
  mapSvg.selectAll('rect')
    ...
    .append('rect')
    .attr('fill', 'black')
    .attr('x', function(d) { return scaleX(d.x) - stokeWidth; })
    .attr('y', function(d) { return scaleY(d.y) - stokeWidth; })
    .attr('width', stokeWidth * 2)
    .attr('height', stokeWidth * 2);
};
...
function drawSegments(segments) {
  ...
  .enter()
  .append('line')
  .attr('id', function(d) {return d['Route Number'] + d['Street Side'];})
        ...
        d3.csv('./Aggregated_FINALV2.csv')
          .then(function(agg_data) {
            ...
            .attr('stroke', function(d){
              ...
              var occupancy_rate = agg_value['6:00 AM Occupied'];
